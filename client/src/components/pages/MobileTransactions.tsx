...
const generateMobileTransactions = (): MobileTransaction[] => {
  const operators = ['Airtel', 'Jio', 'Vi', 'BSNL'];
  const circles = ['Delhi', 'Mumbai', 'Bangalore', 'Chennai', 'Kolkata', 'Hyderabad'];
...
export default function MobileTransactions() {
  const [transactions] = useState<MobileTransaction[]>(generateMobileTransactions());
