...
export default function RealtimeUserRegistrations() {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden hover-lift h-full w-full flex flex-col">
      {/* Header */}
      <div className="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <div className="w-3 h-3 bg-green-400 rounded-full animate-pulse"></div>
            <h3 className="text-base sm:text-lg font-bold text-gray-900 dark:text-white">Live User Registrations</h3>
            <UserPlus className="w-5 h-5 text-green-500" />
          </div>
          <div className="flex items-center space-x-4">
            <div className="text-right">
              <p className="text-xl sm:text-2xl font-bold text-green-600 dark:text-green-400">{totalRegistrations}</p>
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="p-3 sm:p-6">
          <div className="space-y-3 sm:space-y-4 max-h-[350px] sm:max-h-[400px] overflow-y-auto scrollbar-thin">
