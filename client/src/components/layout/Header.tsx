...
import { Search, Bell, ChevronDown, User, Settings, LogOut, Sun, Moon, Menu, Calendar } from 'lucide-react';
        ...
        <div className="flex items-center justify-between gap-2 sm:gap-4">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            <button
              ...
              className="lg:hidden p-1.5 sm:p-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors"
            >
          ...
          <div className="flex items-center space-x-1.5 sm:space-x-2 flex-1 lg:flex-initial">
            <div className="hidden md:block flex-1">
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-9 sm:pl-10 pr-4 py-1.5 sm:py-2 w-full sm:w-64 lg:w-96 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-sm"
                />
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-1.5 sm:space-x-2 md:space-x-3">
            {/* Center Section - Date Filter */}
            <div className="hidden sm:flex items-center space-x-1.5 sm:space-x-2">
              <Calendar className="w-4 h-4 sm:w-5 sm:h-5 text-gray-400" />
              <select
                value={dateFilter}
                onChange={(e) => setDateFilter(e.target.value)}
                className="px-2 sm:px-3 py-1.5 sm:py-2 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-xs sm:text-sm text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
            ...
            <div className="flex items-center space-x-1.5 sm:space-x-2 md:space-x-3">
              {/* Notifications */}
              <div className="relative">
                <button className="relative p-1.5 sm:p-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
                  <Bell className="w-4 h-4 sm:w-5 sm:h-5" />
                  <span className="absolute -top-1 -right-1 w-1.5 h-1.5 sm:w-2 sm:h-2 bg-red-500 text-white text-xs rounded-full flex items-center justify-center"></span>
                </button>
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center space-x-1.5 sm:space-x-2 p-1.5 sm:p-2 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors"
                >
                  ...
                  <p className="text-xs sm:text-sm font-medium text-gray-900 dark:text-white hidden lg:block">Admin User</p>
